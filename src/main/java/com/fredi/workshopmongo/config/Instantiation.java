...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1  = new Post(null,sdf.parse("31/03/2018"), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", maria);
		Post post2  = new Post(null,sdf.parse("323/03/2018"), "Bom dia", "Acordei feliz hoje!", maria);
